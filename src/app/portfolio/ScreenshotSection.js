...
const ScreenshotSection = () => {
  ...
  const isMusicVisible = scrollY > musicTop + 400;
      ...
      >
        <div className={styles.row__text}>
          ...
          <p>
            ...
            then maps that understanding to a music model that produces a list
            of related songs. From there, the generated song list can be pulled
            into a new Vibe and presented to the user. This app would let anyone
            see what kinds of songs matched their Instagram, a task that would
            require a human curator today.
